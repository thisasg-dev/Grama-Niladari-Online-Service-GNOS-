...
import 'profile.dart';
// Note: Ensure your imports for the navigation work correctly
...
class Birth extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // 1. Top Bar (Consistent with Certificate Service)
      appBar: AppBar(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Please ensure all details match your official hospital discharge documents.",
              style: TextStyle(fontSize: 14, color: lightGray),
            ),
            const SizedBox(height: 30),

            // SECTION: SUBJECT IDENTITY
            _buildSectionCard(
              title: 'CHILD INFORMATION',
              children: [
                _buildInputField(
                  'FULL NAME OF CHILD',
                  'දරුවාගේ සම්පූර්ණ නම', // Argument 1: Label
                  'Enter as per hospital record', // Argument 2: Hint
                  // Argument 3: SubHint (Added comma here)
                ),
                _buildInputField(
                  'DATE OF BIRTH',
                  'උපන් දිනය', // Argument 1
                  'mm/dd/yyyy', // Argument 2
                  // Argument 3 (Added comma here)
                ),
                _buildInputField(
                  'PLACE OF BIRTH',
                  'උපන් ස්ථානය', // Argument 1
                  'City or Hospital Name', // Argument 2
                  // Argument 3 (Added comma here)
                ),
              ],
            ),
            ...
            _buildSectionCard(
              title: 'FATHER',
              icon: Icons.person,
              children: [_buildInputField('FULL NAME', 'Legal full name', '')],
            ),
            const SizedBox(height: 20),
            _buildSectionCard(
              title: 'MOTHER',
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 10),
                  Text(
                    'Your application will be cross-referenced with regional health authorities and divisional secretariats.',
                    style: TextStyle(
                      color: lightGray,
                      fontSize: 13,
                      height: 1.4,
...
// Keep the same GnosBottomNav class you used in the first code
